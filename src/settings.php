...
require_once "db.php"; // Sesuaikan dengan path file koneksi database Anda

// Variabel untuk pesan error dan sukses, agar tidak error jika belum di-set
$new_password_err = $confirm_password_err = $success_msg = '';
$is_forced = false; // Contoh, set ke true jika user harus ganti password
...
<div class="sidebar-extra-content scrollable">
    ...
    <div class="expanded-settings-view">
        ...
        <ul class="settings-nav">
            <li class="active"><a href="#"><i class="fas fa-user-circle"></i> <span>Profil</span></a></li>
            <li><a href="#"><i class="fas fa-palette"></i> <span>Tampilan</span></a></li>
            <li><a href="#"><i class="fas fa-globe"></i> <span>Bahasa</span></a></li>
...
<body>
   <?php include 'sidebar.php'; ?>
             ...
             <div class="management-grid" style="grid-template-columns: 2fr 1fr; align-items: start;">
                ...
                <div class="form-container">
                    ...
                    <div class="form-group">
                        ...
                        <!-- Tombol ini sekarang memicu pop-up, bukan pindah halaman -->
    ...
    <!-- ===== KODE POP-UP (MODAL) DITEMPATKAN DI SINI ===== -->
    <div id="passwordModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 transition-opacity duration-300 opacity-0 pointer-events-none">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md transform scale-95 transition-transform duration-300">
            ...
            <main class="p-6">
                <div class="form-container">
                    <?php if($is_forced): ?>
                        <div class="alert alert-warning">Untuk keamanan, Anda harus mengganti password default.</div>
                    <?php endif; ?>
                    <?php if(!empty($success_msg)): ?>
                        <div class="alert alert-success"><?php echo $success_msg; ?></div>
                    <?php endif; ?>

                    <!-- Form action diarahkan ke script pemroses -->
    ...
    <script>
        ...
        openBtn.addEventListener('click', (e) => {
            e.preventDefault(); // Mencegah aksi default jika tombol adalah bagian dari form
            openModal();
        });
