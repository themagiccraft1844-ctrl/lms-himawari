<?php
// File: src/settings/bantuan.php (File BARU - Placeholder)
...
<head>
    ...
    <title>Bantuan - Platform Kursus</title>
    ...
    <div class="main-content">
        ...
        <main>
            <div class="form-container">
                <h3><i class="fas fa-question-circle" style="margin-right: 10px;"></i>Pusat Bantuan</h3>
                <p>Temukan jawaban atas pertanyaan yang sering diajukan (FAQ) atau hubungi dukungan teknis di halaman ini.</p>
            </div>
        </main>
    </div>
