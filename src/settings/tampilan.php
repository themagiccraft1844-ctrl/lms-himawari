<?php
// File: src/settings/tampilan.php (File BARU - Placeholder)
...
<head>
    ...
    <title>Pengaturan Tampilan - Platform Kursus</title>
    ...
    <div class="main-content">
        ...
        <main>
            <div class="form-container">
                <h3><i class="fas fa-palette" style="margin-right: 10px;"></i>Tampilan</h3>
                <p>Fitur untuk mengubah tema (mode gelap/terang) dan kustomisasi tampilan lainnya akan tersedia di sini.</p>
            </div>
        </main>
    </div>
